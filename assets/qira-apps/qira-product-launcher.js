/*! Qira Product Launcher v1.0.0 — generated from canonical registry 78853760caa0ea236ead9d1b6adf2f46d76ecc21
...
(function () {
  ...
  class QiraProductLauncher extends HTMLElement {
    ...
    _showTip(el, text) {
      ...
      t.className = "qira-launcher__tooltip qira-launcher__tooltip--portal";
      t.setAttribute("role", "tooltip");
      t.textContent = text;
      // Always solid light surface + dark text — readable on dark Ledger chrome.
      t.style.cssText = [
        "position:fixed",
        "z-index:2147483646",
        "box-sizing:border-box",
        ...
        "background:#ffffff",
        "color:#202124",
        "font:400 0.8125rem/1.4 Inter,ui-sans-serif,system-ui,sans-serif",
        "white-space:normal",
        "overflow-wrap:anywhere",
        "word-break:break-word",
        "text-align:left",
        "pointer-events:none",
        "box-shadow:0 1px 2px rgba(60,64,67,0.2),0 4px 12px rgba(60,64,67,0.18)",
      ].join(";");
      // Mount on document.body so panel overflow/transform cannot clip the tip.
      document.body.appendChild(t);
      var r = el.getBoundingClientRect();
      var tw = Math.min(280, window.innerWidth - 16);
      t.style.width = tw + "px";
      var th = t.getBoundingClientRect().height || 64;
      var spaceBelow = window.innerHeight - r.bottom;
      var preferBelow = spaceBelow >= th + 12 || r.top < th + 16;
      var top = preferBelow ? r.bottom + 8 : Math.max(8, r.top - th - 8);
